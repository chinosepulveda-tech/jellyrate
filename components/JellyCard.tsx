  ...
  return (
    <article className="border-b border-[#ede9e3] bg-white">
      ...
      <div className="flex items-center px-2 py-1.5 bg-white border-t border-[#f5f2ee]">
        {/* Like */}
        <button onClick={toggleLike} className="flex items-center gap-1.5 px-3 py-2 active:scale-90 transition-transform">
          ...
          {likes > 0 && <span className="text-[13px] font-bold" style={{ color: liked ? "#e8363a" : "#c8c3bc" }}>{likes}</span>}
        </button>

        {/* Comment */}
        <button onClick={() => setShowComments(true)} className="flex items-center gap-1.5 px-3 py-2 active:scale-90 transition-transform">
          <svg width="23" height="23" fill="none" stroke="#c8c3bc" strokeWidth={1.8} viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 01-.923 1.785A5.969 5.969 0 006 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337z" />
          </svg>
          {commentsCount > 0 && <span className="text-[13px] font-bold text-[#c8c3bc]">{commentsCount}</span>}
        </button>
        ...
        >
          <span className="text-[13px] font-black uppercase tracking-wide" style={{ color: rejellyDone ? "#f59e0b" : "#c8c3bc" }}>
            Rejelly
          </span>
          {rejellies > 0 && <span className="text-[13px] font-bold" style={{ color: rejellyDone ? "#f59e0b" : "#c8c3bc" }}>{rejellies}</span>}
        </button>

        {/* Share */}
        <button onClick={() => setShowShare(true)} className="flex items-center gap-1.5 px-3 py-2 active:scale-90 transition-transform">
          <svg width="23" height="23" fill="none" stroke="#c8c3bc" strokeWidth={1.8} viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
          </svg>
        </button>
        ...
        {/* Save */}
        <button onClick={toggleSave} className="flex items-center gap-1.5 px-3 py-2 active:scale-90 transition-transform">
