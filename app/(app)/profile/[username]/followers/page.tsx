    ...
    <div className="min-h-screen bg-[#f2f1ed]">
      <header className="sticky top-0 z-40 bg-white/98 backdrop-blur shadow-sm">
        <div className="flex items-center px-4 py-3.5 gap-3">
          ...
          <div>
            <h1 className="text-sm font-black uppercase tracking-widest text-[#2a2a2a]">Seguidores</h1>
      ...
      <div className="bg-white">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <p className="text-xs font-black uppercase tracking-widest text-[#999]">Sin seguidores aún</p>
          </div>
        ) : (
          people.map(person => (
