      ...
      <div className="bg-white px-4 pt-6 pb-0">
        ...
        <div className="px-2 pb-4">
          <Link href="/profile/settings/privacy">
            <div className="flex rounded-2xl border border-[#e8e3dd] overflow-hidden bg-[#f8f7f5]">
              <div className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 transition-colors ${!isPrivate ? "bg-white shadow-sm" : ""}`}>
                <svg width="13" height="13" fill="none" stroke={!isPrivate ? "#2a2a2a" : "#bbb"} strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" />
                </svg>
                <span className={`text-xs font-black uppercase tracking-wide ${!isPrivate ? "text-[#2a2a2a]" : "text-[#bbb]"}`}>Pública</span>
              </div>
              <div className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 transition-colors ${isPrivate ? "bg-white shadow-sm" : ""}`}>
                <svg width="13" height="13" fill="none" stroke={isPrivate ? "#2a2a2a" : "#bbb"} strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                </svg>
                <span className={`text-xs font-black uppercase tracking-wide ${isPrivate ? "text-[#2a2a2a]" : "text-[#bbb]"}`}>Privada</span>
              </div>
            </div>
          </Link>
        </div>
